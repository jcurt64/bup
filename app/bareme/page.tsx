...
const TIERS: Tier[] = [
  {
    ...
    categories: [
      { name: "Adresse e-mail", value: 0.1, desc: "Contact digital basique" },
      { name: "Prénom & Nom", value: 0.15, desc: "Identification nominale" },
      { name: "Numéro de téléphone", value: 0.2, desc: "Contact direct" },
      {
      ...
      { name: "Nationalité", value: 0.2, desc: "Segmentation géographique" },
    ],
  ...
  },
  {
    ...
    categories: [
      ...
      { name: "Code postal / Ville", value: 0.5, desc: "Zone de chalandise" },
      { name: "Région / Département", value: 0.6, desc: "Ciblage régional" },
      {
        name: "Type de logement",
        value: 1.0,
        desc: "Propriétaire vs locataire",
      },
      { name: "Mobilité géographique", value: 1.2, desc: "Déménagement prévu" },
      {
  ...
  },
  {
    ...
    categories: [
      ...
      { name: "Niveau d'études", value: 5.5, desc: "Segmentation CSP" },
      {
  ...
  },
  {
    ...
    categories: [
      ...
      { name: "Crédit en cours", value: 8.5, desc: "Type & encours" },
      {
