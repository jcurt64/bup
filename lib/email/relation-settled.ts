...
<tr><td style="padding:28px 32px 12px;border-bottom:1px solid #F1ECDB;">
  ...
  <div style="font-size:12px;color:#6B7180;letter-spacing:0.08em;text-transform:uppercase;margin-top:4px;">Récompense créditée</div>
</td></tr>
<tr><td style="padding:28px 32px 8px;">
  <h1 style="margin:0 0 12px;font-family:Georgia,serif;font-size:24px;line-height:1.3;color:#0F1629;font-weight:500;">
    ${escapeHtml(greet)}, vos ${rewardStr} € sont disponibles
  </h1>
  <p style="margin:0 0 14px;font-size:15px;line-height:1.6;color:#3A4150;">
    ...
    quitte le séquestre et est désormais créditée sur votre portefeuille.
  </p>
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin:6px 0 20px;">
    <tr>
      <td style="padding:14px 16px;background:#0F1629;border-radius:10px;color:#FFFEF8;">
        <div style="font-size:11px;color:#A8AFC0;text-transform:uppercase;letter-spacing:.12em;">Crédité sur votre portefeuille</div>
        <div style="font-family:Georgia,serif;font-size:32px;font-weight:600;line-height:1.1;margin-top:4px;">${rewardStr} €</div>
        <div style="font-size:11.5px;color:#A8AFC0;margin-top:6px;">Statut : <strong style="color:#FFFEF8;">Disponible</strong> — retirable selon le seuil en vigueur.</div>
      </td>
    </tr>
  </table>
